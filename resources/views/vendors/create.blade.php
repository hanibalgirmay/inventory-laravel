                ...
                <div class="card-body">
                    ...
                    <div class="container">
                       ...
                       <form method="POST" action="{{ route('vendors.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="mobile2" class="col-md-4 col-form-label text-md-right">{{ __('Other Phone Number') }}</label>

                            <div class="col-md-6">
                                <input id="mobile2" type="number" class="form-control @error('mobile2') is-invalid @enderror" name="mobile2">
                        ...
                        <div class="form-group row">
                            <label for="address2" class="col-md-4 col-form-label text-md-right">{{ __('Other Address') }}</label>
